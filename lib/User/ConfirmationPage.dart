...
class _ConfirmationState extends State<Confirmation> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        automaticallyImplyLeading: false, backgroundColor: Colors.lightGreen,
        title: Text(
          "تاكيد الحجز",
        ),
        centerTitle: true,
                ...
                child: Column(
                  children: <Widget>[
                    Padding(
                      ...
                      child: Text("لقد قمت بإختـيـار", style: TextStyle(
                    ...
                    Row(mainAxisAlignment: MainAxisAlignment.spaceBetween,
                      children: <Widget>[
                        Padding(
                          ...
                          child: Text(" $tp pound", style: TextStyle(
                              fontWeight: FontWeight.bold,
                              color: Colors.green),),
                        ),
                        Padding(
                          padding: const EdgeInsets.all(15.0),
                          child: Text("اجمالي التكلفه", style: TextStyle(
                              fontWeight: FontWeight.bold,
                              color: Colors.grey),),
                        ),
                      ],
                    ...
                    Row(mainAxisAlignment: MainAxisAlignment.center,
                      children: <Widget>[
                        FlatButton(color: Colors.amber, onPressed: () {
                                    ...
                                    child: SingleChildScrollView(
                                      child: new Column(
                                        ...
                                        children: <Widget>[
                                          ...
                                          Padding(
                                            padding: const EdgeInsets.all(8.0),
                                            child: Text("سيصلك كود الدفع علي هذا الرقم"),
                                          ),
                                          Stack(
                                            children: <Widget>[
                                              FlatButton(
